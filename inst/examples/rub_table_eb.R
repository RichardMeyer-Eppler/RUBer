...
df_example <- data.frame(
  ...
  koepfe_rub = c(NA,"7.403","7.416",NA,
                 ...
                 "31%"),
  koepfe_rub_perc = c(NA,"50%","50%",NA,"54%",
  ...
  koepfe_bef_perc = c(NA,"60%","40%",NA,"48%",
...
typology_example <- structure(
  list(
    ...
    colC = c("Studieneingang", "Studierende im 1. HS (WiSe 18/19 bis  WiSe 20/21)", "Studierende im 1. HS (WiSe 18/19 bis  WiSe 20/21)", "Studierende im 1. HS (WiSe 18/19 bis  WiSe 20/21)", "Studierende im 1. HS (WiSe 18/19 bis  WiSe 20/21)"),
    colB = c("Studieneingang", "Angeschrieben", "Angeschrieben", "Gültige Fragebögen", "Gültige Fragebögen"),
    colA = c("Studieneingang", "Köpfe", "(in %)", "Köpfe", "(in %)")
  ),
  class = c("data.frame"),
  row.names = c(NA, -5L)
)
