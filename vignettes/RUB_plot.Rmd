...
provided by `ggplot2` itself. By preconfiguring a lot of the parameters, though, 
RUBer's plotting functions are meant to be more accessible and easier to use. 
One of the inspirations for this was the `bbplot` package used by the data team at BBC News.
...
```{r type-1-example-3, fig.height=10}
# Create test values for all three mandatory variables (x_var, y_var, fill_var)
